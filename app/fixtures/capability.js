...
export default {
  create: function() {
    Capability.reopenClass({
      FIXTURES: [
        { id: 201, features: [301, 306], title: 'Building', subTitle: 'Capability', description: 'BuildingDescription' },
        ...
        { id: 205, features: [303, 304, 307, 308], title: 'Datastorage', subTitle: 'Capability', description: 'DatastorageDescription' }
      ]
    });
  }
};