  ...
  create: function() {
    Tool.reopenClass({
      FIXTURES: [
        ...
        { id: 107, implements: [3051, 3061], title: 'Heroku', subTitle: 'Platform as a Service', description: 'HerokuDescription' },
        { id: 108, implements: [3071], title: 'Neo4J', subTitle: 'Database', description: 'Graph Database' },
        { id: 109, implements: [3081], title: 'Heroku', subTitle: 'OrientDB', description: 'Graph Database' }
      ]
    });
  }
};