  ...
  create: function() {
    Tool.reopenClass({
      FIXTURES: [
        ...
        { id: 107, feature: [305], title: 'Heroku', subTitle: 'Platform as a Service', description: 'HerokuDescription' },
        { id: 108, feature: [306], title: 'Neo4J', subTitle: 'Database', description: 'Graph Database' },
        { id: 109, feature: [307], title: 'Heroku', subTitle: 'OrientDB', description: 'Graph Database' }
      ]
    });
  }
};